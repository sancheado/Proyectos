<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FormularioArchivoTxt.aspx.vb" Inherits="MyWebSite.FormularioArchivoTxt" %>
...
<body style="background-color: #282c34;">
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row">
                <div class="panel" id="PrincipalPanel">
                    ...
                    <div class="row">
                        <button type="button" onclick="dataVerification();" id="btnEnvio" class="btn-pink-moon">                            
                            <span Class="glyphicon glyphicon-check" id="SPANSubmit"></span>
                            <Font id ='lbSubmit' >&nbsp;&nbsp;SEND</font>
                        </button>
                    </div>
                </div>
            </div>
            <br />
            <div class="row">
                <div class="panel-oculto" id="secretPanel" style="display:none;">
                    <div class="panel-header">
                        Results for your file:
                        <span id="spOculto"></span>
                    </div>
                    <div class="row filas">
                        <div class="col-md-6">
                            <label for="infoText">
                    ...
                    <div class="row filas2">
                        <textarea class="myTextArea" id="txtArea"></textarea>                       
                    </div>
                     <div class="row">
        ...
        function dataVerification() {
            ...
            if (input.value != "") {
                ...
                if (file.type == "text/plain") {
                    ...
                    document.getElementById('spOculto').innerHTML = "" + file.name + "<i class='fas fa-file-upload miI'></i>";
                    document.getElementById('type').value = file.type;
                    document.getElementById('dimensions').value = file.size;
                    document.getElementById('modification').value = file.lastModifiedDate;
